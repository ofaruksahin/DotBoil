...
public class OpenIdDictServerConfiguration
{
    ...
    public int? AuthorizationLifetimeMinute { get; set; }
    ...
    public TimeSpan AuthorizationCodeLifetime => AuthorizationLifetimeMinute.HasValue
        ? TimeSpan.FromMinutes(AuthorizationLifetimeMinute.Value)
        : TimeSpan.Zero;
