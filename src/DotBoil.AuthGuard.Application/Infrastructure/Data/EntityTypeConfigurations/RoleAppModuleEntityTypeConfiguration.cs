...
public class RoleAppModuleEntityTypeConfiguration : EFCoreEntityTypeConfiguration<RoleAppModule>
{
    public override void ConfigureDotBoilEntity(EntityTypeBuilder<RoleAppModule> builder)
    {
        builder.ToTable("RoleAppModules");
    }
}