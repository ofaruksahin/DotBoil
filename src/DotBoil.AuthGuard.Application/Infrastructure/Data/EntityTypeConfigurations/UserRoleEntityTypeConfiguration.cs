...
public class UserRoleEntityTypeConfiguration : EFCoreEntityTypeConfiguration<UserRole>
{
    public override void ConfigureDotBoilEntity(EntityTypeBuilder<UserRole> builder)
    {
