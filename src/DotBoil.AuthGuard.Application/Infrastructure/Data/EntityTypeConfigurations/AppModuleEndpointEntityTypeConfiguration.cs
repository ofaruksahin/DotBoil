...
public class AppModuleEndpointEntityTypeConfiguration : EFCoreEntityTypeConfiguration<AppModuleEndpoint>
{
    public override void ConfigureDotBoilEntity(EntityTypeBuilder<AppModuleEndpoint> builder)
    {
        builder.ToTable("AppModuleEndpoints");
    }
}